...
export default function Footer() {
  return (
    <footer className="bg-black/50 border-t border-white/10 pt-16 pb-8 mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8">
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-purple-600 to-pink-500 flex items-center justify-center text-white font-bold shadow-lg">
                S
              </div>
              <span className="text-xl font-bold text-white">soundr</span>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed max-w-xs">
              Accessible to all listeners. Discover, stream, and share a constantly expanding mix of music from emerging and major artists around the world.
            </p>
          </div>
          
          <div>
            <h3 className="text-white font-semibold mb-4 tracking-wider uppercase text-sm">Platform</h3>
            <ul className="space-y-3">
              ...
              <li><Link href="/creator/dashboard" className="text-gray-400 hover:text-white transition-colors text-sm">For Creators</Link></li>
            </ul>
          </div>

          <div>
            <h3 className="text-white font-semibold mb-4 tracking-wider uppercase text-sm">Support</h3>
            <ul className="space-y-3">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="#" className="text-gray-400 hover:text-white transition-colors text-sm">Cookie Settings</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-white/10 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-500 text-sm">
            © {new Date().getFullYear()} Soundr Music Streaming. All rights reserved.
          </p>
